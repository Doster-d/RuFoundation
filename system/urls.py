...
urlpatterns = [
    ...
    path("users/<int:pk>-<slug:slug>",
         profile.ProfileView.as_view(template_name="profile/user.html"), name="users"),
    path("profile", profile.MyProfileView.as_view(
        template_name="profile/user.html"), name="profile"),
    path("profile/edit", profile.ChangeProfileView.as_view(
        template_name="profile/change.html"), name="profile_edit"),

    path('accept/<uidb64>/<token>',
         signup.ActivateView.as_view(template_name="signup/accept.html"), name='accept'),
